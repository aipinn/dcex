...
final class ThemeProviderProvider
    extends $NotifierProvider<ThemeProvider, dynamic> {
...
String _$themeProviderHash() => r'37e7ab985ed092bbcf63946b51d52f6b4cc86b51';

abstract class _$ThemeProvider extends $Notifier<dynamic> {
  dynamic build();
  @$mustCallSuper
  @override
  void runBuild() {
